...
public class CountTreeEdgeTests
{
    ...
    public void WrappedEdge_IsPreserved()
    {
        ...
        var wrapping = new CountTreeEdge<Edge, Node, Builder>(wrapped);
    ...
    {
        var wrapping1 = new CountTreeEdge<Edge, Node, Builder>(new Edge(12));
        var wrapping2 = new CountTreeEdge<Edge, Node, Builder>(new Edge(12));
        Assert.AreEqual(wrapping1, wrapping2);

        var wrapping3 = new CountTreeEdge<Edge, Node, Builder>(new Edge(13));
