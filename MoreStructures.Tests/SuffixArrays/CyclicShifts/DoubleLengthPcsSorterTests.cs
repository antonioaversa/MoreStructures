...
public abstract class DoubleLengthPcsSorterTests
{
    ...
    [DataRow("aa", 1, new [] { 0, 1 }, new[] { 0, 0 }, 
        new[] { 0, 1 })]
    [DataRow("ab", 1, new[] { 0, 1 }, new[] { 0, 1 }, 
        new[] { 0, 1 })]
    [DataRow("aba", 1, new[] { 0, 2, 1 }, new[] { 0, 1, 0 }, 
        new[] { 2, 0, 1 })]
    [DataRow("abba", 1, new[] { 0, 2, 3, 1 }, new[] { 0, 1, 1, 0 }, 
        new[] { 3, 0, 2, 1 })]
    ...
    [DataRow("abcd", 4, new[] { 0, 1, 2, 3 }, new[] { 0, 1, 2, 3 },
        new[] { 0, 1, 2, 3 })]
    [DataRow("cabccba", 1, new[] { 4, 0, 2, 5, 6, 3, 1 }, new[] { 2, 0, 1, 2, 2, 1, 0 }, 
        new[] { 1, 6, 5, 2, 0, 4, 3 })]
    [DataRow("cabccba", 2, new[] { 1, 6, 5, 2, 0, 4, 3 }, new[] { 4, 1, 3, 6, 5, 2, 0 },
        new[] { 1, 6, 5, 2, 0, 4, 3 })]
    [DataRow("cabccba", 3, new[] { 1, 6, 5, 2, 0, 4, 3 }, new[] { 4, 1, 3, 6, 5, 2, 0 },
        new[] { 1, 6, 5, 2, 0, 4, 3 })]
    [DataTestMethod]
